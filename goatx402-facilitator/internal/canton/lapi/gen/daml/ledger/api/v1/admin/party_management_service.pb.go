...
const file_com_daml_ledger_api_v1_admin_party_management_service_proto_rawDesc = "" +
	"\n" +
	...
	"\x1ccom.daml.ledger.api.v1.adminB PartyManagementServiceOuterClassZigithub.com/goat-network/goat-canton-payment/facilitator/internal/canton/lapi/gen/daml/ledger/api/v1/admin\xaa\x02\x1cCom.Daml.Ledger.Api.V1.Adminb\x06proto3"

var (
	file_com_daml_ledger_api_v1_admin_party_management_service_proto_rawDescOnce sync.Once
	file_com_daml_ledger_api_v1_admin_party_management_service_proto_rawDescData []byte
)
...
func file_com_daml_ledger_api_v1_admin_party_management_service_proto_rawDescGZIP() []byte {
	file_com_daml_ledger_api_v1_admin_party_management_service_proto_rawDescOnce.Do(func() {
		file_com_daml_ledger_api_v1_admin_party_management_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_com_daml_ledger_api_v1_admin_party_management_service_proto_rawDesc), len(file_com_daml_ledger_api_v1_admin_party_management_service_proto_rawDesc)))
	})
...
var file_com_daml_ledger_api_v1_admin_party_management_service_proto_goTypes = []any{
...
func file_com_daml_ledger_api_v1_admin_party_management_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_com_daml_ledger_api_v1_admin_party_management_service_proto_rawDesc), len(file_com_daml_ledger_api_v1_admin_party_management_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   13,
			NumExtensions: 0,
			NumServices:   1,
