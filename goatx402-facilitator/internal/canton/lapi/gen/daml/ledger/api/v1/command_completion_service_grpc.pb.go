...
const (
	CommandCompletionService_CompletionStream_FullMethodName = "/com.daml.ledger.api.v1.CommandCompletionService/CompletionStream"
	CommandCompletionService_CompletionEnd_FullMethodName    = "/com.daml.ledger.api.v1.CommandCompletionService/CompletionEnd"
)
...
func (c *commandCompletionServiceClient) CompletionEnd(ctx context.Context, in *CompletionEndRequest, opts ...grpc.CallOption) (*CompletionEndResponse, error) {
	...
	err := c.cc.Invoke(ctx, CommandCompletionService_CompletionEnd_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedCommandCompletionServiceServer) CompletionEnd(context.Context, *CompletionEndRequest) (*CompletionEndResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CompletionEnd not implemented")
}
...
func _CommandCompletionService_CompletionEnd_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CommandCompletionService_CompletionEnd_FullMethodName,
	}
